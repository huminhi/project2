...
top_5_totals.pivot(index='year', columns='state', values='totals').plot(title='Total gun checks/permits; Figure 1', ax=create_y_axis_with_format())
...
# save fig2
kentucky.plot(x='year', kind='area', stacked=True, ax=create_y_axis_with_format(), title='Gun check types in Kentucky; Figure 2')
save_plot('fig2.png')
...
census_data.plot(kind='hist', y='population', bins=40, figsize=(10, 8), title='Population distribution in 2016', label='population', alpha=0.5, ax=create_x_axis_with_format())
save_plot("fig3_1.png")
# select data in 2016
...
top_5_2016.plot(x='state', y=['population', 'permit'], kind='bar', alpha=0.5, label=['population', 'permit'], ax=create_y_axis_with_format(), title='Population vs Gun Permits in 2016; Figure 3')
save_plot("fig3.png")

# plot top 5 states in terms of permit, handgun, long_gun and other
top_5_2016.plot(x='state', y=['permit', 'handgun', 'long_gun', 'other'], kind='bar', alpha=0.5, label=['permit', 'handgun', 'long_gun', 'other'], ax=create_y_axis_with_format(), title='Permit vs Handgun, Long Gun, and Other Firearms in 2016; Figure 4')
save_plot("fig4.png")
